...
import { SiBookstack, SiChatbot } from "react-icons/si";
import { BiBookReader } from "react-icons/bi";
import { MdOutlineApproval } from "react-icons/md";
import AiAssistant from "../AiAssistant";

const DashboardLayout = () => {
  const { logOut, userDB, toggleModal } = useContext(AuthContext);
      ...
      {userDB?.role === "user" && (
        <>
          ...
          <li
            ...
            className={`flex items-center p-2 rounded-lg  border-b-2 border-transparent hover:bg-base-200 cursor-pointer`}
          >
            <SiChatbot className="flex-shrink-0 w-6 h-6  transition duration-75 group-hover:text-gray-900" />
            <span className="flex-1 ml-3 whitespace-nowrap">AI Assistant</span>
          </li>
        </>
      )}
